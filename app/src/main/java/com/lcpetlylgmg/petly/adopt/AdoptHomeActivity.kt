package com.lcpetlylgmg.petly.adopt
...
import com.lcpetlylgmg.petly.databinding.ActivityAdoptHomeBinding
...
class AdoptHomeActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdoptHomeBinding
    private lateinit var userViewModel: UserViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAdoptHomeBinding.inflate(layoutInflater)
