...
class EmailService(private var server: String, private var port: Int) {
    ...
    fun send(email: com.lcpetlylgmg.petly.EmailService.Email) {
        ...
        msg.addHeader("X-Mailer", com.lcpetlylgmg.petly.EmailService.Companion.CLIENT_NAME)
    ...
    companion object {
        const val CLIENT_NAME = "Petly Adminstrator"
    }
}